...
\begin{itemize}
    ...
    %\item \url{https://www.microsoft.com/en-us/research/project/academic}{Microsoft Academic} %PABLO: Microsoft Academic ya no existe, he añadido la WOS
...
\begin{itemize}
    ...
    \item Conclusión: es la sección en la cual debes resumir los hallazgos de ese proceso de revisión crítica de los recursos que has encontrado y analizado. Debes dar importancia a dichos hallazgos y sobre todo enfatizar las lagunas que has encontrado, cómo tu propuesta de proyecto se enmarca en alguna de ellas y cómo puede ayudar a mejorar la situación actual de conocimiento.
\end{itemize}
