...
\begin{itemize}
  ...
  \begin{todolist}
    ...
    \item La portada contiene el título de TFG, tu nombre y el de la persona que te tutoriza, así como la fecha de entrega o, al menos, el curso académico en el que se entrega.
