...
\begin{itemize}
  ...
  \begin{todolist}
    ...
    \item La portada contiene el título de TFG, el nombre del autor y el de la persona que te tutoriza, así como la fecha de entrega o, al menos, el curso académico en el que se entrega.
 ...
 \end{todolist}
  ...
  \begin{todolist}
    ...
    \item Todas las figuras y tablas deben tener un título descriptivo ({\it{caption}}), que en las primeras suele ir situado debajo y en las segundas arriba.
  ...
  \begin{todolist}
    ...
    \item Si he usado figuras, código o documentos multimedia de otros, he citado las fuentes y me he asegurado de que podía usarlas con su licencia original.
  \end{todolist}
