...
Como nota final, recuerda que para presentarlo en la convocatoria extraordinaria de noviembre tienes que haberlo solicitado en la \url{sede.ugr.es} tal y como indica {la web de la ETSIIT}\footnote{\url{https://grados.ugr.es/informatica/docencia/trabajo-fin-grado}}. Hay unos plazos para dicha solicitud, no dejes que se te pase.
