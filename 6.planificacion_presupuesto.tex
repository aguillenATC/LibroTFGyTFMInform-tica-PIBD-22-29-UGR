\chapter{La planificación y los costes del proyecto}
...
\begin{figure}[!t]
    \centering
    \includegraphics[,trim={0 5cm 0 5cm},clip,width=1.0\textwidth]{images/EjemploGantt.pdf}
    %\hyperref{}{Un ejemplo de un diagrama de Gantt desde febrero a julio para 6 tareas}
